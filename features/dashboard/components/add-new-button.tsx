...
import { TemplateSelectionModal } from "../template-modal/template-selection-modal";
  ...
  return (
    <>
      <div
        ...
        className="group md:w-[49%] px-6 py-6 flex flex-row justify-between items-center border rounded-lg bg-muted cursor-pointer 
